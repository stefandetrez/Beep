...
public class BDefines {
    ...
    public static final String BRootPath = "v_1/";
    ...
    public static String ServerUrl = "https://beep-3e40a.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://beep-3e40a.appspot.com";
